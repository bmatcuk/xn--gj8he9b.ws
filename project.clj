(defproject xn--gj8he9b.ws "0.1.0-SNAPSHOT"
  :description "🍩😻.ws"
  :url "http://🍩😻.ws"
  :license {:name "MIT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "xn--gj8he9b.ws.core/on-js-reload"
                ...
                :compiler {:main xn--gj8he9b.ws.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/xn__gj8he9b/ws.js"
